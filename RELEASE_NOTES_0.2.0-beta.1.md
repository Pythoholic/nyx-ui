...
- Nyx UI is maintained by one person. Report vulnerabilities through [SECURITY.md](https://github.com/Pythoholic/nyx-ui/blob/v0.2.0-beta.1/SECURITY.md) and see [CONTRIBUTING.md](https://github.com/Pythoholic/nyx-ui/blob/v0.2.0-beta.1/CONTRIBUTING.md) before contributing.
