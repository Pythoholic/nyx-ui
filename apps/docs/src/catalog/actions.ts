...
export const actionsSection = section(
  ...
  `<div class="docs-grid">
    ...
    ${card("Button group", `<div class="nyx-button-group" role="group" aria-label="View density"><button class="nyx-button" aria-pressed="true">Comfort</button><button class="nyx-button">Compact</button><button class="nyx-button">Dense</button></div>`, "Grouped")}
  </div>`,
  "button action primary secondary quiet destructive icon group loading disabled sizes",
);
