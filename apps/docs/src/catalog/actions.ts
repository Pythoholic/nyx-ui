...
export const actionPages = [
  page({
    ...
    body: `<div class="docs-grid">
      ${card("Canonical button", `<div class="docs-row">${buttonMarkup}</div>`, "Registry source")}
  ...
  page({
    ...
    body: card("Toggle patterns", `<div class="docs-column">${togglesMarkup}</div>`, "Registry source"),
  }),
];
