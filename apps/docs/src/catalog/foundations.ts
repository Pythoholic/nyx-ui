...
export const foundationPages = [
  page({
    ...
    body: `<div class="docs-swatch-grid">
      <div class="docs-swatch" style="--swatch:var(--nyx-void)"><span>Void · #05080B</span></div><div class="docs-swatch" style="--swatch:var(--nyx-panel)"><span>Panel · #0A0F14</span></div><div class="docs-swatch" style="--swatch:var(--nyx-chip)"><span>Chip · #121A1F</span></div><div class="docs-swatch" style="--swatch:var(--nyx-line-strong)"><span>Line · #26313A</span></div><div class="docs-swatch" style="--swatch:var(--nyx-accent)"><span>Accent · Theme</span></div><div class="docs-swatch" style="--swatch:var(--nyx-signal)"><span>Success · #00E08A</span></div><div class="docs-swatch" style="--swatch:var(--nyx-warning)"><span>Warning · #FFB02E</span></div><div class="docs-swatch" style="--swatch:var(--nyx-danger)"><span>Danger · #FF4D5D</span></div>
    </div>`,
  }),
  page({
  ...
  page({
    ...
    description: "Five interaction timings, five recurring-animation timings, and four easing curves cover feedback, entrances, exits, and spatial transitions.",
    searchTerms: "animation motion duration easing transition fade slide scale pulse shimmer spinner reduced motion",
    body: `<div class="docs-motion-grid" data-motion-stage><div class="docs-motion-card"><i class="docs-motion-object nyx-motion-fade"></i><span>Fade · 180ms</span></div><div class="docs-motion-card"><i class="docs-motion-object nyx-motion-slide"></i><span>Slide · 280ms</span></div><div class="docs-motion-card"><i class="docs-motion-object nyx-motion-scale"></i><span>Scale · Spring</span></div><div class="docs-motion-card"><i class="docs-motion-object nyx-motion-pulse"></i><span>Pulse · Status</span></div><div class="docs-motion-card"><i class="docs-motion-object nyx-motion-signal"></i><span>Signal · Attention</span></div></div><div class="docs-row" style="margin-top:var(--nyx-space-4)"><button class="nyx-button" data-motion-replay type="button">Replay motion ${icon("arrow")}</button><span class="nyx-badge">80 · 120 · 180 · 280 · 420ms</span><span class="nyx-badge">750 · 1500 · 1600 · 1700 · 1800ms</span></div>`,
  }),
];
