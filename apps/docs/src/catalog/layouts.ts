...
export const layoutsSection = section(
  ...
  `<div class="docs-stack">
    ...
    ${card("Authentication layout", `<div class="nyx-auth-layout"><div class="nyx-auth-art"><div><span class="nyx-eyebrow">Secure workspace</span><h3 style="font-size:var(--nyx-type-heading-2);margin:.5rem 0 0;text-transform:uppercase">Access the system</h3></div></div><form class="nyx-auth-form"><label class="nyx-field" for="auth-email"><span class="nyx-label">Email</span><input class="nyx-input" id="auth-email" type="email" placeholder="operator@example.com"/></label><label class="nyx-field" for="auth-password"><span class="nyx-label">Password</span><input class="nyx-input" id="auth-password" type="password" value="password"/></label><button class="nyx-button" data-variant="primary" type="submit">Sign in</button></form></div>`, "Auth")}
