...
app.innerHTML = `<div class="docs-shell">
  <header class="docs-topbar">
    <a class="docs-brand" data-docs-link data-docs-path="/" href="${hrefFor("/")}" aria-label="Nyx UI documentation overview"><span class="docs-mark" aria-hidden="true">N</span><span><span class="docs-brand-name">Nyx UI</span><span class="docs-version">System catalog · 0.2.0-beta.2</span></span></a>
...
function render(pathname = window.location.pathname): void {
  ...
  main.innerHTML = page
    ? `${renderPage(page)}<footer class="docs-footer"><span>Nyx UI · v0.2.0-beta.2 · Apache-2.0</span><a href="https://github.com/Pythoholic/nyx-ui">Source repository</a></footer>`
    : notFoundMarkup();
