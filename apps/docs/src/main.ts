  ...
  <div class="docs-layout">
    ...
    <main class="docs-main">
      <section class="docs-hero" id="overview" data-search="overview foundation catalog components">
        ...
        <div class="docs-readout" aria-label="Catalog status"><div class="docs-readout-row"><span>Foundation groups</span><strong>4</strong></div><div class="docs-readout-row"><span>Catalog families</span><strong>9</strong></div><div class="docs-readout-row"><span>Typography roles</span><strong>6 canonical</strong></div><div class="docs-readout-row"><span>Motion tokens</span><strong>10 durations</strong></div><div class="docs-readout-row"><span>Behavior</span><strong style="color:var(--nyx-signal)">Operational</strong></div></div>
      </section>
      ${catalogMarkup}
