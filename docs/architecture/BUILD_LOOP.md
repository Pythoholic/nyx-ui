...
- [x] Documentation outer frame floated away from navigation on wide screens. Main now fills its track and anchors to the sidebar; the single content measure is 144rem, with the existing readable prose clamp and breakpoint gutters preserved. Four routes measured and visually inspected at 390/1280/1920/2560: at 2560 the navigation-to-content gap and trailing space both fell from 504px to 64px, with 949.6px prose and zero left-edge drift or page overflow. The isolated new anchoring assertion failed on original CSS (184px gap at 1920, limit 64px); it also covers 900/1100/3440. 203 unit tests, 99 browser tests, typecheck and build pass. Local before/after tables and captures: `review/frame-width/REPORT.md`.
